...
export default function InterviewComponent() {
  ...
  return (
    <div className="relative overflow-hidden min-h-[calc(100vh-3.5rem)] bg-linear-to-br from-slate-50 to-violet-50/30 px-4 py-12">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-lg shadow-slate-900/5">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <button
                ...
                className="group rounded-xl border-2 cursor-pointer border-slate-200 bg-linear-to-br from-blue-50 to-blue-100/50 p-6 text-left transition-all hover:border-blue-400 hover:shadow-lg"
              >
              ...
              <button
                ...
                className="group rounded-xl border-2 cursor-pointer border-slate-200 bg-linear-to-br from-purple-50 to-purple-100/50 p-6 text-left transition-all hover:border-purple-400 hover:shadow-lg"
              >
